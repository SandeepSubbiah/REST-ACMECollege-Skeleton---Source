...
public class ACMECollegeService implements Serializable {
    ...
    public void buildUserForNewStudent(Student newStudent) {
        ...
        SecurityRole userRole = em.createNamedQuery(SecurityRole.FIND_BY_NAME, SecurityRole.class)
    ...
    public void deleteStudentById(int id) {
        ...
        if (student != null) {
            em.refresh(student);
            TypedQuery<SecurityUser> findUser = em.createNamedQuery(SecurityUser.FIND_BY_USERNAME, SecurityUser.class)
                    .setParameter("username", student.getFirstName() + "." + student.getLastName())
                    .setMaxResults(1);
